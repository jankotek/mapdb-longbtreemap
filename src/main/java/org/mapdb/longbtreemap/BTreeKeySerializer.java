...
public abstract class BTreeKeySerializer<K>{
    ...
    public static final org.mapdb.BTreeKeySerializer BASIC = new org.mapdb.BTreeKeySerializer.BasicKeySerializer(Serializer.BASIC);
     ...
     */
    public static final class BasicKeySerializer extends org.mapdb.BTreeKeySerializer<Object> implements Serializable {
     ...
     * number.
     */
    public static final org.mapdb.BTreeKeySerializer<Long> ZERO_OR_POSITIVE_LONG = new org.mapdb.BTreeKeySerializer<Long>() {
        @Override
        public void serialize(DataOutput out, int start, int end, Object[] keys) throws IOException {
            if(start>=end) return;
     ...
     * number.
     */
    public static final org.mapdb.BTreeKeySerializer<Integer> ZERO_OR_POSITIVE_INT = new org.mapdb.BTreeKeySerializer<Integer>() {
        @Override
        public void serialize(DataOutput out, int start, int end, Object[] keys) throws IOException {
            if(start>=end) return;
     ...
     */
    public static final org.mapdb.BTreeKeySerializer<String> STRING = new org.mapdb.BTreeKeySerializer<String>() {
     ...
     */
    public final  static class Tuple2KeySerializer<A,B> extends org.mapdb.BTreeKeySerializer<Fun.Tuple2<A,B>> implements Serializable {
     ...
     */
    public static class Tuple3KeySerializer<A,B,C> extends org.mapdb.BTreeKeySerializer<Fun.Tuple3<A,B,C>> implements Serializable {
     ...
     * @param <C> third tuple value
     */
    public static class Tuple4KeySerializer<A,B,C,D> extends org.mapdb.BTreeKeySerializer<Fun.Tuple4<A,B,C,D>> implements Serializable {
     ...
     * @param <C> third tuple value
     */
    public static class Tuple5KeySerializer<A,B,C,D,E> extends org.mapdb.BTreeKeySerializer<Fun.Tuple5<A,B,C,D,E>> implements Serializable {
     ...
     * @param <C> third tuple value
     */
    public static class Tuple6KeySerializer<A,B,C,D,E,F> extends org.mapdb.BTreeKeySerializer<Fun.Tuple6<A,B,C,D,E,F>> implements Serializable {
